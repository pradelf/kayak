...
Ce projet est archivé publiquement sur GitHub : [https://github.com/pradelf/kayak](https://github.com/pradelf/kayak).

L'applicatton web du projet est consultable à l'url : <https://dd0kljvyoc0fk.cloudfront.net> grâce à un déploiement ECS d'[AWS](https://aws.amazon.com).

Le stockage S3 des données est dans le compartiment (Bucket) public [https://francis-pradel-jedha-projects.s3.eu-west-3.amazonaws.com/kayak/](https://francis-pradel-jedha-projects.s3.eu-west-3.amazonaws.com/kayak/).

Nous y retrouvons les deux fichiers constituants notre data lake:
...
Les données du Datalake (archivées dans un compartiment (Bucket) S3 d'AWS) et du Datawarehouse (base de données [PostgreSQL](https://www.postgresql.org)  ligne chez [Neon](https://neon.com) ) sont également présentes dans le dépôt sous [le répertoire Data](./Data/data.md).
